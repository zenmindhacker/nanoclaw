...
// Try to create an invoice with more debugging
const invoiceDate = new Date(2026, 1, 1);
...
console.log('Invoice payload:', JSON.stringify(invoice, (key, value) => {
...
try {
  ...
  console.log('Success!');
  console.log('Invoice:', invResponse.body.invoices?.[0]?.invoiceNumber);
} catch (err) {
