...
- **Agent-wide personality or wiki** → Edit `/workspace/global/CLAUDE.local.md` or `/workspace/global/wiki/` directly. Shared across all groups; no approval needed for markdown/memory edits.
