...
function buildVolumeMounts(
  ...
  if (isMain) {
    ...
    // Global directory — shared persona, facts, and memory.
    // Read-write for all groups so the agent can update its own
    // personality, preferences, and knowledge from any context.
