...
/** Host patterns that carry their own OAuth tokens — must bypass OneCLI HTTPS_PROXY. */
const NO_PROXY_ADDITIONS = ['127.0.0.1', 'localhost', '.xero.com', 'identity.xero.com', 'api.xero.com'].join(',');
